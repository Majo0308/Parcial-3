...
class PrestamosH extends StatelessWidget {
  const PrestamosH(
...
class PrestamoDetalles extends StatelessWidget {
...
class Prestamos_get extends StatefulWidget {
  const Prestamos_get({Key key}) : super(key: key);

  @override
  _Relevancia_getState createState() => _Relevancia_getState();
}

class _Relevancia_getState extends State<Prestamos_get> {
