...
class IngresosH extends StatelessWidget {
  const IngresosH(
...
class IngresoDetalle extends StatelessWidget {
  const IngresoDetalle(
      {Key key,
      this.tipo,
      this.etiqueta,
      this.descripcion,
...
class Ingresos_get extends StatefulWidget {
  const Ingresos_get({Key key}) : super(key: key);

  @override
  _Relevancia_getState createState() => _Relevancia_getState();
}

class _Relevancia_getState extends State<Ingresos_get> {
